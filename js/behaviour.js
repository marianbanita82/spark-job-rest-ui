...
$(function() {
    var contextsTable = function () {
        ...
        function getAllJars() {
            return $.ajax({
                url: "http://10.3.22.104:8097/jars/",
                type: "get"
            });
        }
        ...
        function getAllContexts() {
            return $.ajax({
                url: "http://10.3.22.104:8097/contexts/",
                type: "get"
            });
        }
        ...
        function deleteContext(ctxName) {
            return $.ajax({
                url: "http://10.3.22.104:8097/contexts/"+ ctxName,
                type: "delete",
                dataType: "text"
            });
        }
        ...
        function addContext() {
            ...
            return $.ajax({
                url: "http://10.3.22.104:8097/contexts/"+ generatedContext.name,
                type: "post",
                processData: false,
                data: output
            });
